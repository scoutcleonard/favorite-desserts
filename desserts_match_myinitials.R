...
#Read in files to determine if Scout's favorite dessert is on the list of iconic American desserts. 
scout_iconic <- dessert_listing %>% 
  filter(dessert_listing$dessert == "Tiramisu")
